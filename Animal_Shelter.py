...
print('Welcome to the Grazioso Animal Application')
#global variables
userCreateData = {}   #contains input data for write function
userSearchTarget = {}  #contains target data for search function
userUpdateFromTarget = {}  #contains update data for update function
userUpdateToTarget = {}  #contains update data for update function
userDeleteTarget = {}  #contains delete data for delete function
...
class AnimalShelter(object):
    ...
    def __init__(self, user, password):
            ...
            self.client = MongoClient('mongodb://%s:%s@localhost:35634/AAC' % (user, password))
...
sampleData = {
        ...
        'breed': 'Snake',
        'color': 'yellow',
        'date_of_birth': '09302001',
        'datetime': '2020-05-10 10:49:00',
        'monthyear': '2020-05-10T10:49:00',
        'name': 'Suneku',
        'outcome_subtype': 'ABAB',
        'outcome_type': 'Deceased',
        'sex_upon_outcome': 'female',
        'location_lat': 70.684454598,
        'location_long': -91.34349,
        'age_upon_outcome_in_weeks': '40.454'
}
